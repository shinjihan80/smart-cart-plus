...
- **레시피 추천 92종** (한식·양식·일식·중식 + 셰프 스타일·예능 출연 셰프 영감) — 계절(+1.5)·임박(+2)·단골(+최대3)·**영양 힌트(+1)**·**난이도 힌트(±1)** 가중치
- **전체 보기 모달** — 검색 · 7종 필터(전체/이번 계절/즐겨찾기/간단/아침/점심/간식)
...
- **🧠 네모아가 알고 있는 것** — 레시피 92·제철 48·식품11·패션13·저장코디·파트너 9
