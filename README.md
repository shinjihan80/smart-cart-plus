...
- **네모아의 오늘 한 마디** — 11+종 시그널 큐레이션
  ...
  - 쇼핑 리스트(주말 아침/5개+) · 제철 피크 장보기 · 제철 먹기 유도
  - 미착용 의류 · 시간대 인사
...
- **레시피 추천 30종** — 계절(+1.5)·임박(+2)·단골(+최대3)·**영양 힌트(+1)** 가중치
- **전체 보기 모달** — 검색 · 7종 필터(전체/이번 계절/즐겨찾기/간단/아침/점심/간식)
- **상세 모달** — 조리 스텝 · 타이머 · ♥ 즐겨찾기 · 🌸 제철 재료 하이라이트 · 조리 기록
- **재구매 추천** — 소진 히스토리 기반
...
- 종합 통계 + 보관 현황 + 카테고리 분포
- 최근 소진 내역 + 월별 지출 추이
- **🪄 장볼 거 추천** — 임박/소진/제철 3신호 자동 추천, 원탭 쇼핑 담기
...
- **🧠 네모아가 알고 있는 것** — 레시피 30·제철 48·카테 24·파트너 9 한눈에
