...
const FAQS: FaqItem[] = [
  ...
  { q: 'Pro로 업그레이드하면 뭐가 달라지나요?',
    a: 'Pro Lite(₩4,900/월)는 AI 한도가 크게 늘고(사진 300회/월·텍스트 60회/일·영양·URL 각 15회/일), 레시피 142종+ 이용, 파트너 할인 혜택이 생깁니다. Pro Max(₩9,900/월)는 AI 사실상 무제한에 클라우드 자동 동기화를 제공합니다. 현재는 베타 준비 중이며, 마이 → 요금제 카드에서 출시 알림을 신청할 수 있습니다.' },
  { q: '광고는 왜 나오나요?',
    a: '무료로 계속 이용할 수 있도록 하단 배너 광고를 상시 노출하고, 앱을 3번째 실행할 때마다 잠깐 전면 광고가 한 번씩 떠요. 광고는 회피하지 않고 잠깐 보시면 닫을 수 있어요. Pro로 업그레이드하면(출시 예정) 광고 없이 이용할 수 있습니다.' },
  { q: '실수로 아이템을 삭제했어요',
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-4 py-5 flex flex-col gap-2 pb-12">
        ...
        >
          ...
          <Bullet><strong>베이직(무료)</strong> — AI 사진 월 10회·텍스트 5회/일(+광고 최대 3회)·영양 2회/일·위치추천 5회/일(+광고 최대 3회), URL 분석은 Pro 전용. 하단 배너 광고 + 3번째 실행마다 전면 광고</Bullet>
          <Bullet><strong>Pro Lite</strong> — AI 사진 300회/월·텍스트 60회/일·영양·URL 각 15회/일, 레시피 142종+, 파트너 할인, 광고 없음</Bullet>
