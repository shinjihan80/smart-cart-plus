...
const FAQS: FaqItem[] = [
  ...
  { q: '광고는 왜 나오나요?',
    a: '무료로 계속 이용할 수 있도록 하단 배너 광고를 상시 노출하고, 냉장고·옷장에 아이템을 5개 단위로 추가하거나 앱을 3번째 실행할 때마다 짧은 리워드 광고가 한 번씩 떠요. 광고는 회피하지 않고 잠깐 보시면 닫을 수 있어요. Pro로 업그레이드하면(출시 예정) 광고 없이 이용할 수 있습니다.' },
  { q: '실수로 아이템을 삭제했어요',
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-4 py-5 flex flex-col gap-2 pb-12">
        ...
        >
          ...
          <Bullet><strong>베이직(무료)</strong> — AI 사진 월 10회·텍스트 5회/일(+광고 최대 3회)·영양 2회/일·위치추천 5회/일(+광고 최대 3회), URL 분석은 Pro 전용, 프로필 3명까지. 하단 배너 광고 + 아이템 5개 추가·3번째 실행마다 리워드 광고</Bullet>
