...
const FAQS: FaqItem[] = [
  ...
  { q: '광고는 왜 나오나요?',
    a: '무료로 계속 이용할 수 있도록, 앱을 여러 번 실행하거나 냉장고·옷장에 항목을 많이 담는 등 일정 시점에 짧은 영상 광고가 떠요. 연속으로 뜨지 않도록 5분 간격·하루 최대 2회로 제한돼 있습니다. AI 하루 한도를 다 썼을 때 "광고 보고 1회 더"를 선택하면 추가로 볼 수 있어요. Pro로 업그레이드하면(출시 예정) 광고 없이 이용할 수 있습니다.' },
  { q: '실수로 아이템을 삭제했어요',
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-4 py-5 flex flex-col gap-2 pb-12">
        ...
        >
          ...
          <Bullet><strong>베이직(무료)</strong> — AI 사진 월 10회·텍스트 5회/일(+광고 최대 3회)·영양 2회/일·위치추천 5회/일(+광고 최대 3회), URL 분석은 Pro 전용, 프로필 3명까지. 마일스톤 영상 광고는 5분 간격·하루 최대 2회로 제한</Bullet>
