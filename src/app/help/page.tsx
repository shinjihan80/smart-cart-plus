...
const FAQS: FaqItem[] = [
  ...
  { q: 'AI 사용 한도는 얼마나 되나요?',
    a: '무료 기준 — 사진 분석 월 10회 / 텍스트 파싱 하루 5회 / 영양 분석 하루 2회 / 보관 위치 추천 하루 5회. URL 분석은 Pro 전용이라 무료에서는 이용할 수 없어요. 텍스트 파싱과 보관 위치 추천은 하루 한도를 다 쓰면 광고를 보고 하루 최대 3회까지 더 쓸 수 있어요. 사진 분석은 매달 1일에, 나머지는 매일 자정에 초기화됩니다.' },
  { q: 'Pro로 업그레이드하면 뭐가 달라지나요?',
    a: 'Pro Lite(₩4,900/월)는 AI 한도가 크게 늘고(사진 300회/월·텍스트 60회/일·영양·URL 각 15회/일), 레시피 142종+ 이용, 가족 프로필 무제한 추가가 가능해집니다. Pro Max(₩9,900/월)는 AI 사실상 무제한에 클라우드 자동 동기화를 제공합니다. 현재는 베타 준비 중이며, 마이 → 요금제 카드에서 출시 알림을 신청할 수 있습니다.' },
  { q: '광고는 왜 나오나요?',
    a: '무료로 계속 이용할 수 있도록, 냉장고·옷장 아이템을 5개씩 추가하거나, 냉장고·옷장을 3번째부터 새로 만들거나, 앱을 3번째 실행할 때마다 짧은 리워드 광고가 한 번씩 떠요. AI 하루 한도를 다 썼을 때도 광고를 보면 추가로 쓸 수 있어요. 광고는 회피하지 않고 잠깐 보시면 닫을 수 있어요. Pro로 업그레이드하면(출시 예정) 광고 없이 이용할 수 있습니다.' },
  { q: '실수로 아이템을 삭제했어요',
    a: '카드를 펼쳐 삭제하면 하단에 "되돌리기" 버튼이 나타납니다. 다음 행동 전까지 눌러서 복구할 수 있어요.' },
  { q: '알림이 오지 않아요',
    a: '설정 → 알림 설정에서 켜져 있는지 확인하고, 브라우저(또는 앱) 알림 권한도 허용해 주세요.' },
  { q: '가족과 함께 쓸 수 있나요?',
    a: '마이 화면에서 프로필을 추가하면 가족 구성원별로 관리할 수 있습니다. "교체" 버튼으로 현재 사용자를 바꿀 수 있어요. 무료 등급은 프로필 3명까지이며, 초과 시 업그레이드 안내가 표시됩니다. Pro는 무제한이에요.' },
  { q: '오프라인에서도 사용할 수 있나요?',
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-4 py-5 flex flex-col gap-2 pb-12">
        ...
        >
          ...
          <Bullet><strong>베이직(무료)</strong> — AI 사진 월 10회·텍스트 5회/일(+광고 최대 3회)·영양 2회/일·위치추천 5회/일(+광고 최대 3회), URL 분석은 Pro 전용, 프로필 3명까지. 아이템 5개 누적·냉장고/옷장 3번째 생성·3번째 실행마다 리워드 광고</Bullet>
          <Bullet><strong>Pro Lite</strong> — AI 사진 300회/월·텍스트 60회/일·영양·URL 각 15회/일, 레시피 142종+, 프로필 무제한, 광고 없음</Bullet>
          <Bullet><strong>Pro Max</strong> — AI 사실상 무제한, 클라우드 자동 동기화, 광고 없음</Bullet>
