...
const FAQS: FaqItem[] = [
  ...
  { q: 'AI 사용 한도는 얼마나 되나요?',
    a: '무료 기준 — 사진 분석 월 10회 / 텍스트 파싱 하루 5회 / 영양 분석 하루 2회 / URL 분석 하루 2회 / 보관 위치 추천 하루 5회. 텍스트 파싱은 하루 한도를 다 쓰면 광고를 보고 1회 더 쓸 수 있어요(하루 최대 3회 추가). 사진 분석은 매달 1일에, 나머지는 매일 자정에 초기화됩니다.' },
  { q: 'Pro로 업그레이드하면 뭐가 달라지나요?',
    a: 'Pro Lite(₩4,900/월)는 AI 한도가 크게 늘고(사진 30·텍스트 60·기타 각 15회, 전부 하루 기준), 레시피 142종+ 이용, 파트너 할인 혜택이 생깁니다. Pro Max(₩9,900/월)는 AI 사실상 무제한에 클라우드 자동 동기화와 24시간 이내 우선 지원을 제공합니다. 현재는 베타 준비 중이며, 마이 → 요금제 카드에서 출시 알림을 신청할 수 있습니다.' },
  { q: '광고는 왜 나오나요?',
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-4 py-5 flex flex-col gap-2 pb-12">
        ...
        >
          ...
          <Bullet><strong>베이직(무료)</strong> — AI 사진 월 10회·텍스트 5회/일·URL+영양 각 2회/일·위치추천 5회/일, 하단 배너 광고 + 3번째 실행마다 전면 광고</Bullet>
          <Bullet><strong>Pro Lite</strong> — AI 사진 30회·텍스트 60회·URL+영양 각 15회/일(전부 하루 기준), 레시피 142종+, 파트너 할인, 광고 없음</Bullet>
          <Bullet><strong>Pro Max</strong> — AI 사실상 무제한, 클라우드 자동 동기화, 24시간 이내 우선 지원, 광고 없음</Bullet>
