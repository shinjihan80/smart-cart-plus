...
const FAQS = [
  ...
  { q: 'AI 사용량 한도가 뭔가요?',
    a: '무료 플랜 기준 — 사진 분석 월 10회, 텍스트 파싱 하루 5회, 영양 분석 하루 2회, URL 분석 하루 2회, 냉장고 위치 추천 하루 5회. 텍스트 파싱은 하루 한도 소진 후 광고를 보면 하루 최대 3회까지 더 쓸 수 있어요. 사진 분석은 매달 1일, 나머지는 매일 자정에 초기화됩니다.' },
  { q: '광고는 왜 나오나요?',
    a: '무료 이용을 지원하기 위한 광고예요. 상시 배너는 없고, 앱을 여러 번 실행하거나 항목을 많이 담는 등 일정 시점에 짧은 영상 광고가 떠요 — 하루 최대 2회로 제한돼 있습니다. 또 AI 하루 한도를 다 쓴 뒤 "광고 보고 1회 더"를 선택하면 추가로 볼 수 있어요. Pro로 업그레이드하면(출시 예정) 광고가 완전히 사라집니다.' },
  { q: 'Pro 플랜은 얼마인가요?',
