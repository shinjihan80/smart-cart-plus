      ...
      >
        ...
        <div>
          ...
          <div className="flex gap-1 mt-1 flex-wrap">
            <span className="inline-block text-xs px-1.5 py-0.5 rounded-full bg-gray-50 text-gray-400">
              {storageType === '냉장' ? '❄️ 냉장' : storageType === '냉동' ? '🧊 냉동' : '📦 실온'}
            </span>
            {inSeason && (
              <span className="inline-block text-xs px-1.5 py-0.5 rounded-full bg-brand-primary/10 text-brand-primary font-semibold">
      ...
      <Widget index={3} className="!p-0 overflow-hidden">
        <div className="px-5 pt-5 pb-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-300 tabular-nums">{sorted.length}개</span>
          </div>
