      ...
      <div className="flex gap-1.5 flex-wrap">
        {suggestions.map((p) => (
          <button
            ...
            title={p.blurb}
            className="flex items-center gap-1 text-[11px] pl-1.5 pr-2.5 py-1 rounded-2xl bg-brand-primary/5 border border-brand-primary/15 text-brand-primary hover:bg-brand-primary/10 active:scale-95 transition-all"
          >
