          ...
          {NAV_ITEMS.map((entry) => {
            if (entry.kind === 'action') {
              ...
              return (
                ...
                >
                  <span className="w-12 h-12 rounded-full bg-brand-primary text-white flex items-center justify-center shadow-lg shadow-brand-primary/40 -mt-2 active:scale-95 transition-transform">
