    ...
    >
        ...
        <div className="flex items-center gap-1">
          {shopping.list.length >= 2 && (
            <button
              ...
              className="text-sm font-semibold px-2 py-0.5 rounded-full bg-brand-success/10 text-brand-success hover:bg-brand-success/15 transition-colors"
            >
              모두 담기
            </button>
          )}
          <button
            ...
            className="text-sm text-gray-400 font-medium px-2 py-0.5 rounded-full hover:bg-gray-100 transition-colors"
      ...
      {importOpen && (
        <div className="mb-3 rounded-xl border border-brand-primary/15 bg-brand-primary/5 p-2.5">
          <p className="text-sm text-gray-500 mb-1.5">한 줄에 하나씩, 또는 쉼표로 구분해 붙여넣어요</p>
          <textarea
            value={importText}
          ...
          <div className="flex gap-1 mt-1.5 justify-end">
            ...
            <button
              ...
              className="text-sm font-semibold px-2.5 py-0.5 rounded-full bg-brand-primary text-white hover:opacity-90 disabled:opacity-40 transition-opacity"
            >
              가져오기
            </button>
          </div>
                  ...
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    {g.items.length >= 2 && (
                      <button
                        ...
                        className="ml-auto text-xs font-semibold text-brand-success hover:underline"
                      >
                        그룹 담기 →
                      </button>
                    )}
                    ...
                    return (
                      <div key={it.id} className="flex items-center gap-2 py-1.5">
                        ...
                        <button
                          ...
                          className="shrink-0 text-sm font-semibold px-2 py-1 rounded-full bg-brand-success/10 text-brand-success hover:bg-brand-success/15 transition-colors"
                        >
                          담았어요
                        </button>
                        <button
                          ...
                          title="제거"
                          className="shrink-0 text-sm text-gray-300 hover:text-brand-warning px-1 py-1 transition-colors"
                        >
                          ✕
                        </button>
                      </div>
